...
def test_resolve_path_and_discover_repo_local_korali_site(monkeypatch, tmp_path):
    ...
    site_a = runtime_root / "korali" / "install" / "lib" / "python3.11" / "site-packages"
    site_b = runtime_root / "korali" / "install" / "lib" / "python3.12" / "site-packages"
    ...
    monkeypatch.setenv("MESOUQ_SITE_RUNTIME_ROOT", str(tmp_path / "empty-runtime"))
