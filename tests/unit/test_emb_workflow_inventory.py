...
EMB_WORKFLOW_ENTRYPOINTS = (
    ...
    "emb/compression/src/generate.py",
    "emb/compression/src/parameters.py",
    "emb/indentation/src/generate.py",
    "emb/indentation/src/parameters.py",
    # DNN/BNN surrogate evaluation.
    "src/meso_uq/surrogate/emb_workflows.py",
    "emb/compression/surrogate/evaluate.py",
    ...
    "emb/compression/surrogate/scripts/emb_train.py",
    "emb/compression/surrogate/scripts/emb_train_bnn.py",
    "emb/compression/surrogate/scripts/run_group_holdout.py",
    "emb/compression/surrogate/scripts/train_multi_arch.py",
    "emb/indentation/surrogate/scripts/emb_train.py",
    "emb/indentation/surrogate/scripts/emb_train_bnn.py",
