...
echo "WARNING: scripts/vega/bootstrap_mirheo.sh is a deprecated Vega-specific entrypoint." >&2
echo "WARNING: use scripts/hpc/bootstrap_mirheo.sh with HPC_SITE=vega|karolina." >&2
...
echo "  $python_bin $repo_root/scripts/vega/doctor_vega.py --strict --with-mirheo"
