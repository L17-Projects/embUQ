...
def main(argv: list[str] | None = None) -> int:
    ...
    manifest: MappingLike = {
        ...
        "commands": {
            ...
            "regenerate": "python scripts/qa/noise_hierarchy_release_readiness.py --output-root <output-root> ...",
            "gate07": "python scripts/qa/noise_gate07_release_checks.py --release-manifest <manifest> --output-root <gate-root>",
        },
        "modes": mode_specs,
