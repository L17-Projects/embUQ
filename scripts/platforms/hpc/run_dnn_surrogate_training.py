...
def _sbatch_template(site: str) -> Path:
    return REPO_ROOT / "scripts" / "platforms" / site / "sbatch" / "train_dnn_arch_array.sbatch"
...
SPECS = [
    {
        ...
        "diameter": "2.1",
        "script": REPO_ROOT / "emb" / "compression" / "surrogate" / "scripts" / "train_multi_arch.py",
        "best": REPO_ROOT / "emb" / "compression" / "surrogate" / "diameters" / "2.1um" / "trained" / "microbubble_force_BEST.pkl",
    },
    {
        ...
        "diameter": "2.9",
        "script": REPO_ROOT / "emb" / "compression" / "surrogate" / "scripts" / "train_multi_arch.py",
        "best": REPO_ROOT / "emb" / "compression" / "surrogate" / "diameters" / "2.9um" / "trained" / "microbubble_force_BEST.pkl",
    },
    {
        ...
        "diameter": "3.0",
        "script": REPO_ROOT / "emb" / "compression" / "surrogate" / "scripts" / "train_multi_arch.py",
        "best": REPO_ROOT / "emb" / "compression" / "surrogate" / "diameters" / "3.0um" / "trained" / "microbubble_force_BEST.pkl",
    },
    {
        "name": "indentation_3.2um",
        "experiment": "indentation",
        "diameter": "3.2",
        "script": REPO_ROOT / "emb" / "indentation" / "surrogate" / "scripts" / "train_multi_arch.py",
        "best": REPO_ROOT / "emb" / "indentation" / "surrogate" / "diameters" / "3.2um" / "trained" / "microbubble_displacement_BEST.pkl",
    },
    {
        ...
        "diameter": "3.4",
        "script": REPO_ROOT / "emb" / "indentation" / "surrogate" / "scripts" / "train_multi_arch.py",
        "best": REPO_ROOT / "emb" / "indentation" / "surrogate" / "diameters" / "3.4um" / "trained" / "microbubble_displacement_BEST.pkl",
    },
    {
        ...
        "diameter": "5.8",
        "script": REPO_ROOT / "emb" / "indentation" / "surrogate" / "scripts" / "train_multi_arch.py",
        "best": REPO_ROOT / "emb" / "indentation" / "surrogate" / "diameters" / "5.8um" / "trained" / "microbubble_displacement_BEST.pkl",
    },
]
...
def _submit_array_job(*, spec: dict[str, Path | str], output_root: Path, args: argparse.Namespace, site: str) -> tuple[str, dict[str, str], Path, Path]:
    ...
    if not sbatch_template.is_file():
        raise FileNotFoundError(f"No DNN training sbatch template for site={site}: {sbatch_template}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    for spec in selected_specs:
        ...
        job_id, submit_logs, _models_dir, report_file = _submit_array_job(spec=spec, output_root=output_root, args=args, site=resolved_site)
        run_entry = {
            "name": name,
            "status": "submitted",
            "experiment": str(spec["experiment"]),
