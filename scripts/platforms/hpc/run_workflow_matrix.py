...
def _build_selection_commands(
    ...
    *,
    ...
    hpc_scripts = REPO_ROOT / "scripts" / "platforms" / "hpc"
    site_args = ["--site", site]

    inference_base = [
        python_bin,
        str(hpc_scripts / "run_inference_stage.py"),
        "--experiment",
    ...
    propagation_base = [
        python_bin,
        str(hpc_scripts / "run_propagation.py"),
        "--experiment",
        selection.experiment,
        "--model-family",
        selection.model_family,
    ...
    map_base = [
        python_bin,
        str(hpc_scripts / "extract_map.py"),
        "--experiment",
        selection.experiment,
        "--model-family",
        selection.model_family,
    ...
    if run_map_mirheo:
        commands.append((
            ...
            [
                python_bin,
                str(hpc_scripts / "run_map_mirheo.py"),
