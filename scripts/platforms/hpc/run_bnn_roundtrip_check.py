...
_SELECTIONS: dict[str, dict[str, str]] = {
    "compression_2.1um": {
        ...
        "diameter_um": "2.1",
        "data": "emb/compression/surrogate/diameters/2.1um/data/F_Delta.dat",
        "dnn": "emb/compression/surrogate/diameters/2.1um/trained/microbubble_force_BEST.pkl",
        "out_stem": "microbubble_force",
    },
    "compression_2.9um": {
        "modality": "compression",
        "diameter_um": "2.9",
        "data": "emb/compression/surrogate/diameters/2.9um/data/F_Delta.dat",
        "dnn": "emb/compression/surrogate/diameters/2.9um/trained/microbubble_force_BEST.pkl",
        "out_stem": "microbubble_force",
    },
    "compression_3.0um": {
        "modality": "compression",
        "diameter_um": "3.0",
        "data": "emb/compression/surrogate/diameters/3.0um/data/F_Delta.dat",
        "dnn": "emb/compression/surrogate/diameters/3.0um/trained/microbubble_force_BEST.pkl",
        "out_stem": "microbubble_force",
    },
    "indentation_3.2um": {
        "modality": "indentation",
        "diameter_um": "3.2",
        "data": "emb/indentation/surrogate/diameters/3.2um/data/samples_all.dat",
        "dnn": "emb/indentation/surrogate/diameters/3.2um/trained/microbubble_displacement_BEST.pkl",
        "out_stem": "microbubble_displacement",
    },
    "indentation_3.4um": {
        "modality": "indentation",
        "diameter_um": "3.4",
        "data": "emb/indentation/surrogate/diameters/3.4um/data/samples_all.dat",
        "dnn": "emb/indentation/surrogate/diameters/3.4um/trained/microbubble_displacement_BEST.pkl",
        "out_stem": "microbubble_displacement",
    },
    "indentation_5.8um": {
        "modality": "indentation",
        "diameter_um": "5.8",
        "data": "emb/indentation/surrogate/diameters/5.8um/data/samples_all.dat",
        "dnn": "emb/indentation/surrogate/diameters/5.8um/trained/microbubble_displacement_BEST.pkl",
        "out_stem": "microbubble_displacement",
    },
}
