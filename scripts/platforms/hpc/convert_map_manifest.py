...
Input manifest format (produced by scripts/platforms/hpc/extract_map.py):
    {
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        required=True,
        type=Path,
        help="Path to *_map_manifest.json (produced by scripts/platforms/hpc/extract_map.py)",
    )
    parser.add_argument(
        "--output-dir",
        required=True,
