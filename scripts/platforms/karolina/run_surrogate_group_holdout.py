...
TARGET = REPO_ROOT / "scripts" / "platforms" / "hpc" / 'run_surrogate_group_holdout.py'
...
def main(argv: list[str] | None = None) -> int:
    ...
    if requested_site is None:
        ...
        print(
            ...
            f"use scripts/platforms/hpc/run_surrogate_group_holdout.py for --site {requested_site}.",
            file=sys.stderr,
        )
        return 2
