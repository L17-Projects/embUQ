...
SBATCH_SCRIPT="${REPO_ROOT}/scripts/platforms/karolina/sbatch/gv_paper_figure_replay.sbatch"
...
MESOUQ_SCRATCH_ROOT="${MESOUQ_SCRATCH_ROOT:-/scratch/project/${MESOUQ_PROJECT_ID}/eubrieucb/mesouq}"
MESOUQ_RUNS_ROOT="${MESOUQ_RUNS_ROOT:-${MESOUQ_SCRATCH_ROOT}/runs}"
