...
Source: Hierarchical_UQ_compression_dev/compression/src/equil.py
"""
...
def run_equil(
    ...
    config_paths = [
        "../../inference/configs/production/inference_config_compression.yaml",  # From compression/src/
        ...
        "../inference/configs/production/inference_config_compression.yaml",  # From compression/
        "../inference/configs/production/inference_config.yaml",  # Legacy compression/ filename
    ]
    config_file = None
