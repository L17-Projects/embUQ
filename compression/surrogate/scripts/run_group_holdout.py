...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Run grouped holdout evaluation for compression surrogates."
    )
    ap.add_argument("--diameter", required=True, help="Diameter label (example: 2.9)")
    ap.add_argument("--data-file", required=True, help="Path to compression training data table.")
    ...
    spec = resolve_modality_spec("compression")
